...
class Solution:
    ...
    @classmethod
    def product_except_self_short(cls, nums: List[int]) -> List[int]:
    ...
    @classmethod
    def product_except_self_brute_force(cls, nums: List[int]) -> List[int]:
...
if __name__ == '__main__':
    ...
    print(Solution.product_except_self([12, 4, 6, 8]))
